...
namespace ShopManagementSystem {
    ...
    public partial class ShopManagementSystemDataSet : global::System.Data.DataSet {
        ...
        public partial class UserInfoDataTable : global::System.Data.TypedTableBase<UserInfoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UserInfoRow AddUserInfoRow(string ID, string Name, string Password, string Type, string Email, string Address, string Phone_Number, System.DateTime Date_of_Birth) {
        ...
        public partial class UserInfoRow : global::System.Data.DataRow {
            ...
            public string Type {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Type\' in table \'UserInfo\' is DBNull.", e);
                    }
                }
                set {
            ...
            public System.DateTime Date_of_Birth {
                get {
                    try {
                        return ((global::System.DateTime)(this[this.tableUserInfo.Date_of_BirthColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public bool IsTypeNull() {
                return this.IsNull(this.tableUserInfo.TypeColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetTypeNull() {
                this[this.tableUserInfo.TypeColumn] = global::System.Convert.DBNull;
            }
...
namespace ShopManagementSystem.ShopManagementSystemDataSetTableAdapters {
    ...
    public partial class UserInfoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[UserInfo] WHERE (([ID] = @Original_ID) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_Type = 1 AND [Type] IS NULL) OR ([Type] = @Original_Type)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Phone_Number = 1 AND [Phone Number] IS NULL) OR ([Phone Number] = @Original_Phone_Number)) AND ((@IsNull_Date_of_Birth = 1 AND [Date of Birth] IS NULL) OR ([Date of Birth] = @Original_Date_of_Birth)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[UserInfo] ([ID], [Name], [Password], [Type], [Email], [Address], [Phone Number], [Date of Birth]) VALUES (@ID, @Name, @Password, @Type, @Email, @Address, @Phone_Number, @Date_of_Birth);
SELECT ID, Name, Password, Type, Email, Address, [Phone Number], [Date of Birth] FROM UserInfo WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[UserInfo] SET [ID] = @ID, [Name] = @Name, [Password] = @Password, [Type] = @Type, [Email] = @Email, [Address] = @Address, [Phone Number] = @Phone_Number, [Date of Birth] = @Date_of_Birth WHERE (([ID] = @Original_ID) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_Type = 1 AND [Type] IS NULL) OR ([Type] = @Original_Type)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Phone_Number = 1 AND [Phone Number] IS NULL) OR ([Phone Number] = @Original_Phone_Number)) AND ((@IsNull_Date_of_Birth = 1 AND [Date of Birth] IS NULL) OR ([Date of Birth] = @Original_Date_of_Birth)));
SELECT ID, Name, Password, Type, Email, Address, [Phone Number], [Date of Birth] FROM UserInfo WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ShopManagementSystem.Properties.Settings.Default.ShopManagementSystemConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Password, Type, Email, Address, [Phone Number], [Date of Birth] " +
                "FROM dbo.UserInfo";
        ...
        public virtual int Fill(ShopManagementSystemDataSet.UserInfoDataTable dataTable) {
        ...
        public virtual ShopManagementSystemDataSet.UserInfoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ShopManagementSystemDataSet.UserInfoDataTable dataTable = new ShopManagementSystemDataSet.UserInfoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ShopManagementSystemDataSet.UserInfoDataTable dataTable) {
        ...
        public virtual int Delete(string Original_ID, string Original_Password, string Original_Type, string Original_Email, string Original_Address, string Original_Phone_Number, global::System.Nullable<global::System.DateTime> Original_Date_of_Birth) {
            if ((Original_ID == null)) {
        ...
        public virtual int Insert(string ID, string Name, string Password, string Type, string Email, string Address, string Phone_Number, global::System.Nullable<global::System.DateTime> Date_of_Birth) {
            if ((ID == null)) {
        ...
        public virtual int Update(string ID, string Name, string Password, string Type, string Email, string Address, string Phone_Number, global::System.Nullable<global::System.DateTime> Date_of_Birth, string Original_ID, string Original_Password, string Original_Type, string Original_Email, string Original_Address, string Original_Phone_Number, global::System.Nullable<global::System.DateTime> Original_Date_of_Birth) {
            if ((ID == null)) {
                throw new global::System.ArgumentNullException("ID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Password, string Type, string Email, string Address, string Phone_Number, global::System.Nullable<global::System.DateTime> Date_of_Birth, string Original_ID, string Original_Password, string Original_Type, string Original_Email, string Original_Address, string Original_Phone_Number, global::System.Nullable<global::System.DateTime> Original_Date_of_Birth) {
            return this.Update(Original_ID, Name, Password, Type, Email, Address, Phone_Number, Date_of_Birth, Original_ID, Original_Password, Original_Type, Original_Email, Original_Address, Original_Phone_Number, Original_Date_of_Birth);
        }
    }
